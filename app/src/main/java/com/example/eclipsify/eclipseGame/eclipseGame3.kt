...
@Composable
fun eclipseGame3(navController: NavHostController) {
    ...
    Box(modifier = Modifier.fillMaxSize()){
            ...
            title = {
                ...
                )
                {
                    Icon(
                        ...
                        contentDescription = "",
                        tint = Color.White, modifier = Modifier.clickable { navController.navigate("KidScreen") }
                    )
                }
            },
        ...
        Column(Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Box(
                ...
                Image(
                    painterResource(id = R.drawable.game3),
                    contentDescription = "",
        ...
        Column(Modifier.fillMaxSize(), verticalArrangement = Arrangement.Bottom, horizontalAlignment = Alignment.CenterHorizontally){
            ...
            AnimatedVisibility(visible) {
                Button(onClick = { navController.navigate("EclipseGame4") }, modifier = Modifier
                    .size(303.dp, 55.dp)
                    .offset(0.dp, -80.dp)
                ...
                OutlinedCard(
                    Modifier
                        .size(75.dp, 75.dp).offset(230.dp,-470.dp)
        ...
        Image(painter = painterResource(id = R.drawable.ecl3), contentDescription ="",
            Modifier
                .offset(240.dp, 270.dp)
                .size(150.dp, 150.dp)
